...
public class grid32x16z_wavefronts_my_way extends PApplet {
...
public void draw()
{
  ...
  float prevX = smoothX;
  float prevY = smoothY;
  smoothX += (mouseX - smoothX) * 0.1f;
  smoothY += (mouseY - smoothY) * 0.1f;
...
public class OPC implements Runnable
{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "grid32x16z_wavefronts_my_way" };
    if (passedArgs != null) {
